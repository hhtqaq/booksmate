 ...
 */
public class GeneratorNamePicUtil {

//    public static void main(String[] args) throws IOException {
//        generateImg("B", "E:\\booksmate\\bookfile\\avator", "a");
//        generateImg("罗", "E:\\booksmate\\bookfile\\avator", "b");
//
//    }
    ...
    public static void generateImg(String name, String outputPath, String outputName)
        ...
        if (nameWritten.length() >= 2) {
            ...
            if (isChinese(firstWritten) && isChinese(secondWritten)) {
                g2.drawString(nameWritten, 37, 100);
            }
            //首中次英 如 罗Q
            else if (isChinese(firstWritten) && !isChinese(secondWritten)) {
                g2.drawString(nameWritten, 40, 100);
        ...
        if (nameWritten.length() == 1) {
            ...
            if (isChinese(nameWritten)) {
                font = new Font("微软雅黑", Font.PLAIN, 70);
                g2.setFont(font);
                g2.drawString(nameWritten, 55, 110);
            }
            //英文
            else {
                font = new Font("微软雅黑", Font.PLAIN, 75);
                g2.setFont(font);
                g2.drawString(nameWritten.toUpperCase(), 65, 115);
            }
